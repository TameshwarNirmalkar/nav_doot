...
const MainHeader = () => {
  ...
  const content = (
    <div className="flex">
      <ul className="">
        <li className="flex align-middle border-b-1 border-b-blue-200 p-1">
          <span>Notifiction</span>
        </li>
        <li className="flex align-middle border-b-1 border-b-blue-200 p-1">Buyer 3</li>
        <li className="flex align-middle border-b-1 border-b-blue-200 p-1">Customer request</li>
        <li className="flex align-middle border-b-1 border-b-blue-200 p-1">Orders</li>
        <li className="flex align-middle border-b-1 border-b-blue-200 p-1">Consignment status</li>
        <li className="flex align-middle border-b-1 border-b-blue-200 p-1">Dispatch</li>
      </ul>
    </div>
  );
