...
const AddAgentsFormComponent = () => {
  ...
  //     const formVal = await addAgentsForm.getFieldsValue(true);
  //     addAgentsForm.setFieldValue('state_name', opt.name);
  ...
  //   (val: string, opt: any) => {
  //     addAgentsForm.setFieldValue('city_name', opt.name);
  //   },
  //   [dispatch],
  // );
...
export default memo(AddAgentsFormComponent);
