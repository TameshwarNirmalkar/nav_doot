...
import { selectBranchesList, addBranch, updadateBranch, removeBranch } from '@src/store/branches';
...
const BranchesWrapper = () => {
  ...
  return (
    <>
      ...
      >
        <TableComponent rowKey={'id'} columns={columns} dataSource={allBranches} />
      </Card>
