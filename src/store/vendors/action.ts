...
import { VendorsCollection } from '.';

export const getVendorAction = createAsyncThunk('GET_VENDORS', async () => {
  try {
...
export const addVendorAction = createAsyncThunk('ADD_VENDOR_TYPE', async (args: VendorsCollection) => {
  try {
    // const res = await fetch(`https://csc.sidsworld.co.in/api/countries`, {
    //   method: 'GET',
    //   headers: {
...
export const updateVendorAction = createAsyncThunk('EDIT_VENDOR_TYPE', async (args: VendorsCollection) => {
  try {
    // const res = await fetch(`https://csc.sidsworld.co.in/api/countries`, {
    //   method: 'GET',
    //   headers: {
